...
add_action( 'plugins_loaded', 'mime_types_plus_load_textdomain' );
/** ==================================================
 * i18n
 *
 * @since 1.00
 */
function mime_types_plus_load_textdomain() {
	load_plugin_textdomain( 'mime-types-plus' );
}

if ( ! class_exists( 'MimeTypesPlusRegist' ) ) {
	require_once( dirname( __FILE__ ) . '/lib/class-mimetypesplusregist.php' );
}
if ( ! class_exists( 'MimeTypesPlusAdmin' ) ) {
	require_once( dirname( __FILE__ ) . '/lib/class-mimetypesplusadmin.php' );
}
if ( ! class_exists( 'MimeTypesPlus' ) ) {
	require_once( dirname( __FILE__ ) . '/lib/class-mimetypesplus.php' );
}
